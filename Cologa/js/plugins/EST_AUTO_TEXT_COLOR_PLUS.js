...
@desc Use Autocolor only on message. window help, etc won't have effect (true / false)
@default true
...
{
  if (key == 'OnlyUseInMessage') EST.AutoColor.OnlyUseInMessage = Number(EST.AutoColor.param[key]);
...
Window_Base.prototype.convertEscapeCharacters = function(text) {
  ...
  // if(Imported != undefined && Imported.YEP_MessageCore) xtext = Yanfly.Message.Window_Base_convertEscapeCharacters.call(this, text);
  if(Yanfly && Yanfly.Message) xtext = Yanfly.Message.Window_Base_convertEscapeCharacters.call(this, text);
    var word, use, regex;
