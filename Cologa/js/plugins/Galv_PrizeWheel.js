...
//-----------------------------------------------------------------------------
/*:
 * @plugindesc (v.1.1) Get random items by spinning a prize wheel
 * 
...
Scene_PrizeWheel.prototype.loadRequiredImages = function() {
	...
	for (var i = 0; i < $gameSystem._prizeWheelFront.length; i++) {
		ImageManager.loadPicture($gameSystem._prizeWheelFront[i]);
	}
	for (var i = 0; i < $gameSystem._prizeWheelBack.length; i++) {
		ImageManager.loadPicture($gameSystem._prizeWheelBack[i]);
	}
};
...
Scene_PrizeWheel.prototype.updateReady = function() {
...
Scene_PrizeWheel.prototype.createGraphics = function() {
	...
	this._wheel.bitmap = ImageManager.loadPicture(Galv.PRIZE.wheelimg);
