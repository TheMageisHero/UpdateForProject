 ...
 * @plugindesc v1.2.1058 [Pro] The real-time action battle system
 * 
 * @help
 * 
 * Web Page: 
 ...
 * @default Never
 * @desc Show HP bar above enemies and allies on ABS Map
 *
 * @param UIE_Buttons
 * @text UI Buttons
 * @parent UI_Elements
 ...
 * @text Custom Buttons Names
 * @parent UIE_Buttons
 * @type string
 * @default
 * @desc Buttons names from JSON (separate by comma)
 *
 * @param Enemies
 * @default --------------------
 *
...
(function() {
  ...
  //?[FROM ATBS]
  DefaultKeyConfig = ['w', 'd', 's', 'a', 'e', 'q', 'w', 'd', 's', 'a', '1', '2', '3', '4', '5', '6', '7', '8', 'r', 'f', 'control', 'z'];
...
(function () {
  ...
  SDK.setConstant(Game_AIBehavior, 'PARAMS', ['viewRadius', 'returnRadius', 'escapeOnBattle',
    ...
    'faceName', 'faceIndex', 'HPBarStyle', 'motionDelay', 'motionFrames', 'motionADelay'
  ]);
...
(function() {
  ...
  Game_AIBot.prototype.refreshGlobal = function() {
    ...
    return SlowUpdateManager.register(this.eventId(), this._stateMachine, 300);
  };
  //$[OVER I]
...
ButtonsProManager.loadABS = function() {
  ...
  return ButtonsProManager.createButton('shield');
};
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (DataManager.isArmor(equip)) {
        ...
        if (((ref1 = equip.meta) != null ? ref1.visual : void 0) != null) {
          this._visualEqData = equip.meta.visual;
          break;
        } else {
          results.push(void 0);
        }
...
(function() {
  ...
  _._changeAAShieldState = function() {
    if (this._inAAShieldState === true) {
      return this._removeAAShieldState();
    } else {
      return this._addAAShieldState();
    }
  };
  _._removeAAShieldState = function() {
  ...
  _.isCanApplyShieldNow = function() {
    return this.isCanApplyShieldState() && (this.battler()._shieldRestTimer == null) && this._absParams.casting === false;
  };
})();
...
(function() {
  var _, ___alias_UPDATE;
  //@[DEFINES]
  _ = AA.LIBS.Sprite_CharacterABS.prototype;
  //TODO: Followers support
  ___alias_UPDATE = _._updateABS;
  _._updateABS = function() {
    var b, ref;
    ___alias_UPDATE.call(this);
    if ($gameMap.isABS()) {
      b = (ref = this._character) != null ? ref.battler() : void 0;
    } else {
      if ((this._character != null) && this._character instanceof Game_Player) {
        b = $gameParty.leader();
      }
    }
    if (b == null) {
  ...
  _._isVisualEqCreated = function() {
    return this._visualEquipmentSprite != null;
  };
  _._updateVisualEq = function() {
    return this._updateVisualEqFrame();
  };
  _._updateVisualEqFrame = function() {
    var b, blockX, blockY, ph, pw, sx, sy;
    b = this._visualEquipmentSprite.bitmap;
    pw = b.width / 3;
    ph = b.height / 4;
    //index = 0
    blockX = 0; //index % 4 * 3
    ...
    this._visualEquipmentSprite.setFrame(sx, sy, pw, ph);
    if (this._character.inABSMotion()) {
      this._visualEquipmentSprite.y = this.__baseVESy - this._absMotionOffset();
    }
    if (this._character.inAAnimMotion() && this._character.__AnimMotionReady === true) {
      return this._visualEquipmentSprite.y = this.__baseVESy - this._AAnimMotionOffset();
    }
  };
  _._createVisualEq = function() {
    var b, name, ref;
    this._clearVisualEq();
    b = (ref = this._character) != null ? ref.battler() : void 0;
    if (b == null) {
    ...
    name = b._getVisualEqData();
    if (name == null) {
      return;
    }
    //"VES: created".p()
    name = name + "_Char";
    this._visualEquipmentSprite = new Sprite(ImageManager.loadAAEquip(name));
    b = this._visualEquipmentSprite.bitmap;
    b.addLoadListener(() => {
      this._visualEquipmentSprite.move(-this.width / 2, -this.height);
      if (b.width !== this.width) {
        this._visualEquipmentSprite.x = -(b.width / 3) / 2;
      }
      if (b.height !== this.height) {
        this._visualEquipmentSprite.y = -(b.height / 4);
      }
      return this.__baseVESy = this._visualEquipmentSprite.y;
    });
    return this.addChild(this._visualEquipmentSprite);
  };
  _._clearVisualEq = function() {
    if (!this._isVisualEqCreated()) {
      return;
    }
    this.removeChild(this._visualEquipmentSprite);
    return this._visualEquipmentSprite = null;
  };
})();
...
// Generated by CoffeeScript 2.3.1
//╒═════════════════════════════════════════════════════════════════════════╛
// ■ Sprite_EnemyHpBar.coffee
//╒═════════════════════════════════════════════════════════════════════════╛
//---------------------------------------------------------------------------
(function() {
  var Sprite_EnemyHPBar;
  Sprite_EnemyHPBar = class Sprite_EnemyHPBar extends Sprite {
    constructor() {
      super();
      this.gauge = new AlphaABS.LIBS.UI_GaugeABS_HP(40, 10);
      this._configurteGauge();
    ...
    _configurteGauge() {
      var dx, dy;
      this.gauge._leftGaugeText = function() {
        return '';
      };
      this.gauge._isShowValue = false;
      dx = -this.gauge.width / 2;
      dy = -this.gauge.height;
      return this.gauge.move(dx, dy);
    }
    ...
    _applyParameters() {
      ...
      try {
        ...
        //if AlphaABS.Parameters.isLoaded()
        //params = AlphaABS.Parameters.get_UIE_MiniHPBar()
        //@gauge.applyPluginParameters params
        e = error;
        AlphaABS.error(e, 'while load mini HP bar parameters');
      }
    }

    setup(character) {
      return this.gauge.setBattler(character.battler());
    }

  };
  AlphaABS.register(Sprite_EnemyHPBar);
})();

// ■ END Sprite_EnemyHpBar.coffee
//---------------------------------------------------------------------------
...
(function() {
  ...
  SpriteActorPortrait = class SpriteActorPortrait extends AASprite {
    ...
    //?{NEW}
    drawVisualEq(fileName) {
      var tBitmap;
      if (this._visualEqSprite == null) {
        this._createVisualEq();
      } else {
        this._visualEqSprite.bitmap.clear();
      }
      if (fileName == null) {
        return;
      }
      ...
      return tBitmap.addLoadListener(() => {
        ...
        sx = 0;
        sy = 0;
        return this._visualEqSprite.bitmap.blt(tBitmap, sx, sy, pw, ph, 0, 0, this._face.width, this._face.height);
      });
    }

    _createVisualEq() {
      this._visualEqSprite = AASprite.FromBitmap(this.settings.faceSize);
      return this._face.addChild(this._visualEqSprite);
    }
...
(function() {
  ...
  Spriteset_InterfaceABS.prototype.redrawVisualOnFace = function() {
    ...
    if (actor._getVisualEqData() == null) {
      ...
      name = actor._getVisualEqData() + "_Face";
      return this._faceSprite.drawVisualEq(name);
    }
  };
})();
...
(function() {
  ...
  SpriteSpellInfo = class SpriteSpellInfo extends AASprite {
    ...
    _getCastTime() {
      return SDK.decimalAdjust('round', this.skill.getCastTime($gamePlayer.battler()) / AA.BattleManagerABS.TURN, -1) + AA.SYSTEM.STRING_SKILL_INFO_SEC;
    }
    ...
    commandStackReloadTime(dy) {
      ...
      reloadStack = SDK.decimalAdjust('round', this.skill.stackTime / AA.BattleManagerABS.TURN, -1);
...
AlphaABS.getVersionInfo = function() {
  return AlphaABS.Version + " [Pro] build " + AlphaABS.Build + " on MV " + Utils.RPGMAKER_VERSION;
};
...
(function(){
    ...
    Window_Base.prototype.drawActorFace = function (actor, x, y, width, height) {
        ...
        if (actor.isHasVisualEq()) {
            this._drawAAVisualEq(actor._getVisualEqData(), x, y, width, height);
        }
    };
...
//Plugin Alpha_ABS automatic build by MVPluginBuilder 1.6.2 08.06.2019
