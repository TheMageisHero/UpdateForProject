...
-------------------------------------------------------------------------
@plugindesc Allows you to use side-view actors as enemies.
@help 
-------------------------------------------------------------------------
== Description ==
...
Nov 22, 2015 - fixed state overlays being mirrored on enemies
...
(function ($) {
  ...
  var TH_SpriteEnemy_initMembers = Sprite_Enemy.prototype.initMembers;
  Sprite_Enemy.prototype.initMembers = function() {
    TH_SpriteEnemy_initMembers.call(this);
    this._svActorName = '';
  };
  
  var TH_SpriteEnemy_updateBitmap = Sprite_Enemy.prototype.updateBitmap;
  Sprite_Enemy.prototype.updateBitmap = function() {
    if (this._useSVActorSprite) {
      Sprite_Battler.prototype.updateBitmap.call(this);
    }
    else {
      TH_SpriteEnemy_updateBitmap.call(this);
    }
  };
  
  var TH_SpriteEnemy_updateFrame = Sprite_Enemy.prototype.updateFrame;
  Sprite_Enemy.prototype.updateFrame = function() {    
    if (this._useSVActorSprite) {
      ...
      TH_SpriteEnemy_updateFrame.call(this);
    }    
  };
